...
namespace dotPad.Controls
{
    public class ExtendedRadioButton : RadioButton
    {
        #region Variables

        public static readonly DependencyProperty IconProperty = DependencyProperty.Register(nameof(Icon), typeof(ImageSource), typeof(ExtendedRadioButton), new FrameworkPropertyMetadata());
